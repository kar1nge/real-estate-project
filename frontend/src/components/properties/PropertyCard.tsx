...
function PropertyCard({
    ...
    switch (variant) {
                    ...
                    <div className="absolute inset-x-8 bottom-8 flex items-end justify-between">
                        ...
                        <div className="text-right text-white">
                            ...
                            <h3 className="text-3xl font-light">
                                KSh {Number(property.starting_price).toLocaleString()}
                            </h3>
                            ...
                            <div className="mt-6 flex items-center justify-end gap-2 text-sm uppercase tracking-[0.25em] text-white opacity-0 transition-all duration-300 group-hover:opacity-100">
                ...
                <div className="group relative h-full overflow-hidden rounded-[28px]">
                    ...
                    <div className="absolute inset-x-6 bottom-6 text-white">
                        ...
                        <div className="mt-3 flex items-end justify-between">
                            ...
                            <span className="translate-x-0 text-xl opacity-0 transition-all duration-300 group-hover:translate-x-1 group-hover:opacity-100">
                                →
                            </span>
        ...
        case "compact":
            return (
                <div className="group relative h-full overflow-hidden rounded-[24px]">
                    ...
                    <div className="absolute inset-x-5 bottom-5 text-white">
                        ...
                        <div className="mt-2 flex items-center justify-between">
                            ...
                            <span className="translate-x-0 text-lg opacity-0 transition-all duration-300 group-hover:translate-x-1 group-hover:opacity-100">
                                →
                            </span>
